import { PrismaClient, MenuItem, $Enums, User } from '@prisma/client'
import { NewPasswordEncoder } from '../lib/shared/encoders/password'
const db = new PrismaClient()

async function main() {
	console.log("Seeding the db")
	const encoder = NewPasswordEncoder("");
	...
	let users = [
		{
			...
			username: 'azeek',
			password: await encoder("azeek1234")
		},
		{
			name: "Waiter Alisa",
			role: $Enums.UserRoles.WAITER,
			username: 'alisa',
			password: await encoder("alisa1234")
		},
	]
